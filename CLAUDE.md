...
autoresearch/                     Autoresearch experiment tracking:
  autoresearch/seed_paper.md        Research problem description (generated by autoresearch_config.py)
...
# Manual OpenFOAM (local)
cd openfoam/f1_baseline && blockMesh && snappyHexMesh -overwrite && simpleFoam

# OpenFOAM via Docker (Apple Silicon compatible)
cd openfoam/f1_baseline && ../../scripts/openfoam-docker.sh blockMesh
cd openfoam/f1_baseline && ../../scripts/openfoam-docker.sh simpleFoam
...
- **README.md** - rewritten 2026-03-31 to match actual project state
